    ...
    <section className="why-choose-us">
      <div className="content">
        ...
        <p className="description">
          We understand that every kitchen is unique. That’s why we take the time to understand your vision, needs, and budget. Whether you’re looking for a minor refresh or a complete transformation, our team delivers bespoke solutions tailored to you.
        </p>
        <div className="features">
          ...
          <div className="feature">
            ...
            <p>Tailored Designs <br/><strong>for Every Kitchen</strong></p>
          </div>
          <div className="feature">
