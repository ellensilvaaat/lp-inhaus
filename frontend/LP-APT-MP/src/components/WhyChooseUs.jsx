    ...
    <section className="why-choose-us">
      <div className="content">
        ...
        <p className="description">
          We understand that every apartment renovation is special. That’s why we take the time to learn
          about your style, needs, and budget.
          Whether you’re upgrading a single room or reimagining your entire space, we tailor our services
        ...
        <div className="features">
          ...
          <div className="feature">
            ...
            <p>Tailored Designs <br/><strong>for Every Apartment</strong></p>
          </div>
          <div className="feature">
